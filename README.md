...
| 116  | [Populating Next Right Pointers in Each Node](https://leetcode.com/problems/populating-next-right-pointers-in-each-node/)                       | [Python](./Leetcode/116.py) 	| Medium | O(n) 	| O(log(depth)) 	|  	| 
| 124  | [Binary Tree Maximum Path Sum](https://leetcode.com/problems/binary-tree-maximum-path-sum/)                                                     | [Python](./Leetcode/124.py) 	| Hard | O(n) 	| O(d) where d = tree depth (worst case also n) 	|  	| 
...
| 300  | [Longest Increasing Subsequence](https://leetcode.com/problems/longest-increasing-subsequence/)                                                 | [Python](./Leetcode/300.py) 	| Medium | O(n\*log(n)) 	| O(n) 	|  	| 
...
| 418  | [Sentence Screen Fitting](https://leetcode.com/problems/sentence-screen-fitting/)                                                               | [Python](./Leetcode/418.py) 	| Medium | O(~r \* c ) 	| O(w) 	|  	| 
| 460  | [LFU Cache](https://leetcode.com/problems/lfu-cache/)                                                                                           | [Python](./Leetcode/460.py) 	| Hard | O(1) for getting and setting 	| O(n)-ish 	|  	| 
| 492  | [License Key Formatting](https://leetcode.com/problems/license-key-formatting/)                                                                 | [Python](./Leetcode/492.py) 	| Easy | O(n) 	| O(n) 	|  	| 
| 543  | [Diameter of Binary Tree](https://leetcode.com/problems/diameter-of-binary-tree/)                                                               | [Python](./Leetcode/543.py) 	| Easy | O(n) 	| O(d) 	|  	| 
| 547  | [Number of Provinces](https://leetcode.com/problems/number-of-provinces/)                                                                       | [Python](./Leetcode/547.py) 	| Medium | O(n^2) 	| O(n) 	|  	| 
| 560  | [Subarray Sum Equals K](https://leetcode.com/problems/subarray-sum-equals-k/)                                                                   | [Python](./Leetcode/560.py) 	| Medium | O(n) 	| O(n) 	|  	| 
| 593  | [Valid Square](https://leetcode.com/problems/valid-square/)                                                                                     | [Python](./Leetcode/593.py) 	| Medium | O(1) 	| O(1) 	|  	| 
| 616  | [ Add Bold Tag in String](https://leetcode.com/problems/add-bold-tag-in-string/)                                                                | [Python](./Leetcode/616.py) 	| Mediun | O(w + n*m) 	| O(w + n) 	|  	| 
| 647  | [Palindromic Substrings](https://leetcode.com/problems/palindromic-substrings/)                                                                 | [Python](./Leetcode/647.py) 	| Medium | O(n^2) 	| O(1) 	|  	| 
| 652  | [Find Duplicate Subtrees](https://leetcode.com/problems/find-duplicate-subtrees/submissions/)                                                   | [Python](./Leetcode/652.py) 	| Medium | O(n^2) 	| O(n^2) 	|  	| 
...
| 792  | [Number of Matching Subsequences](https://leetcode.com/problems/number-of-matching-subsequences/)                                               | [Python](./Leetcode/792.py) 	| Medium | O(n * m) 	| O(m) 	|  	| 
...
| 937  | [Reorder Data in Log Files](https://leetcode.com/problems/reorder-data-in-log-files/)                                                           | [Python](./Leetcode/937.py) 	| Easy | O(n\*log(n)) 	| O(n) 	|  	| 
...
| 1041 | [Robot Bounded In Circle](https://leetcode.com/problems/robot-bounded-in-circle/)                                                               | [Python](./Leetcode/1041.py) 	| Medium | O(n) 	| O(1) 	|  	| 
| 1074 | [Number of Submatrices That Sum to Target](https://leetcode.com/problems/number-of-submatrices-that-sum-to-target/)                             | [Python](./Leetcode/1074.py) 	| Hard | O(n^2\*m) 	| O(n\*m) 	|  	| 
...
| 1136 | [Parallel Courses](https://leetcode.com/problems/parallel-courses/)                                                                             | [Python](./Leetcode/1136.py) 	| Medium | O(V + E) 	| O(V + E) 	|  	| 
| 1167 | [Minimum Cost to Connect Sticks](https://leetcode.com/problems/minimum-cost-to-connect-sticks/)                                                 | [Python](./Leetcode/1167.py) 	| Medium | O(n\*log(n)) 	| O(n) 	|  	| 
...
| 1465 | [Maximum Area of a Piece of Cake After Horizontal and Vertical Cuts](https://leetcode.com/problems/maximum-area-of-a-piece-of-cake-after-horizontal-and-vertical-cuts/) | [Python](./Leetcode/1465.py) 	| Medium | O(n\*log(n)) 	| O(n) 	|  	| 
| 1472 | [Design Browser History](https://leetcode.com/problems/design-browser-history/)                                                                 | [Python](./Leetcode/1472.py) 	| Medium | ~O(1) 	| O(n) 	|  	| 
| 1499 | [Max Value of Equation](https://leetcode.com/problems/max-value-of-equation/)                                                                   | [Python](./Leetcode/1499.py) 	| Hard | O(n\*log(n)) 	| O(n) 	|  	| 
| 1525 | [Number of Good Ways to Split a String](https://leetcode.com/problems/number-of-good-ways-to-split-a-string/)                                   | [Python](./Leetcode/1525.py) 	| Medium | O(n) 	| O(n) 	|  	| 
...
| 1648 | [Sell Diminishing-Valued Colored Balls](https://leetcode.com/problems/sell-diminishing-valued-colored-balls/)                                   | [Python](./Leetcode/1648.py) 	| Medium | O(n\* log(n)) 	| O(n) 	|  	| 
...
| 1776 | [Car Fleet II](https://leetcode.com/problems/car-fleet-ii/)                                                                                     | [Python](./Leetcode/1776.py) 	| Hard | O(n) 	| O(n) 	|  	| 
