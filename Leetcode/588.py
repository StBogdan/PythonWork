...
class FileSystem:
    ...
    def _dir_to_str(directory: Dict[str, dict]) -> str:
        return sorted(list(directory['_files'].keys()) + list(directory['_dirs'].keys()))
...
if __name__ == "__main__":
    ...
    ops = ["FileSystem","mkdir","ls","mkdir","ls","ls","ls","addContentToFile","ls","ls","ls"]
    ops_args =[[],["/m"],["/m"],["/w"],["/"],["/w"],["/"],["/dycete","emer"],["/w"],["/"],["/dycete"]]
